...
export function associateUser(): void {
  const { RefreshToken } = require('./refreshToken.model') as typeof import('./refreshToken.model');
  const { Device } = require('./device.model') as typeof import('./device.model');
  ...
  const { Budget } = require('./budget.model') as typeof import('./budget.model');
  const { Goal } = require('./goal.model') as typeof import('./goal.model');
  const { Notification } = require('./notification.model') as typeof import('./notification.model');
  const { FamilyGroup } = require('./familyGroup.model') as typeof import('./familyGroup.model');
  const { AiConversation } = require('./aiConversation.model') as typeof import('./aiConversation.model');
