...
import * as loanService from '@shared/modules/loans/loans.service';
import type { CreateLoanInput, PayLoanInput, UpdateLoanInput } from '@shared/modules/loans/loans.types';
