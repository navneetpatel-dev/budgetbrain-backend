...
import * as accountService from '@shared/modules/accounts/accounts.service';
import type { CreateAccountInput, UpdateAccountInput } from '@shared/modules/accounts/accounts.types';
