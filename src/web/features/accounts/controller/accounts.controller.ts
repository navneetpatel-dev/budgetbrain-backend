...
import * as accountService from '@shared/modules/accounts/service/account.service';
import type { CreateAccountInput, UpdateAccountInput } from '@shared/modules/accounts/types';
